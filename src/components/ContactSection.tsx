    ...
    <section id="contact" className="py-20 bg-gray-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-[#0A2540] mb-4">Contact Us</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Reach out to us for a consultation or to discuss how we can assist with your legal needs.
          </p>
        </div>
          ...
          <div className="md:flex">
            <div className="md:w-2/5 bg-[#0A2540] text-white p-8 md:p-12">
              ...
              <p className="mb-8 text-white/80">
                We're here to help with your legal questions and concerns. Fill out the form or contact us directly using the information below.
              </p>
            ...
            <div className="md:w-3/5 p-8 md:p-12">
              <h3 className="text-2xl font-bold text-[#0A2540] mb-6">Request a Consultation</h3>
